...
def configure(conf):
    ...
    conf.check_cfg(package='gtk+-3.0', uselib_store='GTK', atleast_version='3.0.0', mandatory=True, args='--cflags --libs')
    ...
    # Again, explicitly define osmgpsmap because it's terrible.     
